...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "MSAL", url: "https://www.yapstudios.com/frameworks/MSAL.xcframework.zip", checksum: "a9e971443793d1b1e1a38f97c8f2d8e75fe46a59584325d26f4f2d00354a1255"),
